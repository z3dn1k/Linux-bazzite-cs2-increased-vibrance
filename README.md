...
2. gamescope -w 1080 -h 1080 --> makes a custom resolution and starts the game with it for me i use 1080x1080 you can either change it or remove it
...
#### All the steps are in turorial.txt im too lazy to write it in markdown :(
